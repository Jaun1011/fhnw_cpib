...
val productions = [
    ...
    (typedIdent,
        [[T IDENT, T COLON, N atomtype, N opt15]]),
    (atomtype,
        [[N choice0]]),
    (cmd,
        [[T SKIP]
        ,[N expr, T BECOMES, N expr]
        ,[T IF, N expr, T THEN, N cpsCmd, N opt16, T ENDIF]
        ,[T WHILE, N expr, T DO, N cpsCmd, T ENDWHILE]
        ,[T CALL, T IDENT, N exprList, N opt17]
        ,[T DEBUGIN, N expr]
        ,[T DEBUGOUT, N expr]]),
    (cpsCmd,
        [[N cmd, N rep3]]),
    ...
    (identChars,
        [[T CHAR, N rep5]]),
    (identArray,
        [[N identChars, N choice1]]),
    (arrayBrackets,
        [[T LEBRKT, N expr, T REBRKT]]),
    (expr,
        [[N term1, N rep6]]),
    (term1,
        [[N term2, N opt18]]),
